...
public final class ClassUtils {
    public static final String APPLICATION_PACKAGE = "com.gj.cloud";
    ...
    /**
     * Instantiate a class with type value pairs, the {@code typeValuePairs} types are<br>
     * {@code Class} objects that identify the constructor's formal parameter types,<br>
     * in declared order. The {@code typeValuePairs} values are the initialization<br>
     * parameters to create and initialize with the identical constructor.
     */
    @SafeVarargs
    public static final <T> T newInstance(final Class<T> clazz, Pair<? extends Class<?>, ? extends Object>... typeValuePairs) {
     ...
     */
    public static final <T> Constructor<T> getConstructorIfAvailable(Class<T> clazz, Class<?>... parameterTypes) {
        try {
    ...
    public static final <T> Class<T> getClass(String className) {
        ...
        try {
            ...
            throw new BusinessException(cnfe);
        }
    }

    @SuppressWarnings("unchecked")
    public static final <T> Class<T> getApplicationClass(String simpleName) {
        return (Class<T>) getAllClasses(APPLICATION_PACKAGE).stream()
    ...
    public static final <T> List<Class<?>> getConcreteClassList(Class<T> interfaceOrAbstractClazz) {
        return MemoryCacheHelper.get("CONCRETECLASS_" + interfaceOrAbstractClazz.getName(),
                () -> getPredicatedClasses(APPLICATION_PACKAGE, c -> interfaceOrAbstractClazz.isAssignableFrom(c)
