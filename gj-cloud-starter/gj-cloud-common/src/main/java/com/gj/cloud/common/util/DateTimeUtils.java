...
import com.gj.cloud.common.converter.exception.ConversionFailedException;
...
public class DateTimeUtils {
    ...
    public static final LocalDate thisMonday() {
        return thisDayOfWeek(DayOfWeek.MONDAY);
    }

    public static final LocalDate thisTuesday() {
        return thisDayOfWeek(DayOfWeek.TUESDAY);
    }

    public static final LocalDate thisWednesday() {
        return thisDayOfWeek(DayOfWeek.WEDNESDAY);
    }

    public static final LocalDate thisThursday() {
        return thisDayOfWeek(DayOfWeek.THURSDAY);
    }

    public static final LocalDate thisFriday() {
        return thisDayOfWeek(DayOfWeek.FRIDAY);
    }

    public static final LocalDate thisSaturday() {
        return thisDayOfWeek(DayOfWeek.SATURDAY);
    }

    public static final LocalDate thisSunday() {
        return thisDayOfWeek(DayOfWeek.SUNDAY);
    }
    ...
    private static final LocalDate thisDayOfWeek(DayOfWeek dayOfWeek) {
        LocalDate now = LocalDate.now();

        DayOfWeek nowDayOfWeek = now.getDayOfWeek();

        if (dayOfWeek.equals(nowDayOfWeek)) {
            return now;
        }

        if (nowDayOfWeek.getValue() > dayOfWeek.getValue()) {
            return now.minusDays(nowDayOfWeek.getValue() - dayOfWeek.getValue());
        }

        return now.plusDays(dayOfWeek.getValue() - nowDayOfWeek.getValue());
    }
}
