package com.gj.cloud.gateway.utils;
...
public class JwtUtils {
     ...
     */
    private static final String CLIENT_SECRET = "gj";

    /**
     * 认证服务器暴露的获取token_key的地址
     */
    private static final String AUTH_TOKEN_KEY_URL = "http://gj-authcenter/oauth/token_key";
